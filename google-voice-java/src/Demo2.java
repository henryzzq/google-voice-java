...
public class Demo2 {
    ...
    public static String speech = "Are you henry, I'm cismon";
    public static void main(String[] args) throws Exception {
        Language language = Language.valueOf("en".toUpperCase());
        String text = speech;
        text = URLEncoder.encode(text, "utf-8");
        new Demo2().go(language, text);
    }
    ...
    public void go(Language language, String text) throws Exception {
        ...
        // Done, save data
        String filePath = "C:\\eclipse-cismon\\ws-cismon\\google-voice-java\\src\\output.mp3";
